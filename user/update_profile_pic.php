...
?>
	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?> <h2 align="center">Update Your Image</h2></Td>
	</Tr>
				
					<tr>
						<td>Choose Your pic</td>
					<td><input class="form-control"  type="file" name="f" /></td></tr>
				<tr>
					
<Td colspan="2" align="center">
<input type="submit" class="btn btn-default" value="Update My Profile Pic" name="update" style="background-color:maroon;color:white;text-align:center;"/>
