...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" style="background-color:maroon;color:white;">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#" style="color:white;">Hello <?php echo $users['name'];?></a>
        </div>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
			   <li><a href="index.php?page=notification" style="color:maroon;"><span class="glyphicon glyphicon-envelope"></span>   All Notification</a></li>
			...
			<li><a href="index.php?page=update_password" style="color:maroon;"><span class="glyphicon glyphicon-user"></span> Update Password</a></li>
            <li><a href="index.php?page=update_profile" style="color:maroon;"><span class="glyphicon glyphicon-user"></span> Update Profile</a></li>
