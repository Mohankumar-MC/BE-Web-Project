...
?>
	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?><h2 align="center">Update Your Profile</h2></Td>
	</Tr>
...
<input type="submit" class="btn btn-default" value="Update My Profile" name="update" style="background-color:maroon;color:white;text-align:center;"/>
<input type="reset" class="btn btn-default" value="Reset" style="background-color:maroon;color:white;text-align:center;"/>
