...
<form method="post">
	...
	<div class="row" style="margin-top:10px">
		...
		<input type="submit" value="Update Password" name="save" class="btn btn-success" style="background-color:maroon;color:white;text-align:center;"/>
		<input type="reset" class="btn btn-success" style="background-color:maroon;color:white;text-align:center;"/>
		</div>
	</div>
</form>	